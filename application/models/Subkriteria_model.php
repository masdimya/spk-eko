...
class Subkriteria_model extends CI_Model
{
    ...
    function index(){
        $query = " SELECT
                    ...
                    FROM
                    subkriteria
                    LEFT JOIN nilai_kategori ON nilai_kategori.id_nilai = subkriteria.id_nilai
                    LEFT JOIN kriteria ON kriteria.id_kriteria = subkriteria.id_kriteria";
    ...
    function get_by_kriteria_id($id_kriteria)
    {
        $query = " SELECT
                    ...
                    subkriteria 
                    LEFT JOIN nilai_kategori ON nilai_kategori.id_nilai = subkriteria.id_nilai
                    LEFT JOIN kriteria ON kriteria.id_kriteria = subkriteria.id_kriteria  WHERE kriteria.id_kriteria = '$id_kriteria' ORDER BY nama_subkriteria ASC  ";
                    return $this->db->query($query);
    }
    ...
    function subkriteria_add($id_kriteria,$ket)
    {
